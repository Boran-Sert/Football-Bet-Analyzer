...
async def get_similar_matches(
    ...
    """Bir macin benzer gecmis maclarini dondurur. Auth ve Rate Limit gerektirir.

    S-13 Fix: RateLimiter artik Depends() ile cozumleniyor.
    Boylece request.state.user_tier dogrudan kullanilabilir.
    """
